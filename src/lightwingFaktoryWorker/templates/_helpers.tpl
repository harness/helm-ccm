...
{{- define "lwd-worker.generateMountSecrets" }}
    ce-batch-gcp-credentials: {{ include "harnesscommon.secrets.passwords.manage" (dict "secret" "lwd-worker-secret-mount" "key" "ce-batch-gcp-credentials" "providedValues" (list "ce-batch-gcp-credentials") "length" 10 "context" $) }}
{{- end }}

{{- define "lightwingFaktoryWorker.pullSecrets" -}}
