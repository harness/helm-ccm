...
| batch-processing.awsServiceEndpointUrls.cloudwatchEndPointUrl | string | `"https://monitoring.us-east-2.amazonaws.com"` |  |
| batch-processing.awsServiceEndpointUrls.ec2EndPointUrl | string | `"https://ec2.us-east-2.amazonaws.com"` |  |
| batch-processing.awsServiceEndpointUrls.ecsEndPointUrl | string | `"https://ecs.us-east-2.amazonaws.com"` |  |
| batch-processing.awsServiceEndpointUrls.enabled | bool | `true` |  |
| batch-processing.awsServiceEndpointUrls.endPointRegion | string | `"us-east-2"` |  |
| batch-processing.awsServiceEndpointUrls.s3EndPointUrl | string | `"https://s3.us-east-2.amazonaws.com"` |  |
| batch-processing.awsServiceEndpointUrls.stsEndPointUrl | string | `"https://sts.us-east-2.amazonaws.com"` |  |
...
| batch-processing.image.tag | string | `"80005-000"` |  |
...
| batch-processing.imageClickhouseEnabled.tag | string | `"80005-000"` |  |
...
| nextgen-ce.awsServiceEndpointUrls.cloudwatchEndPointUrl | string | `"https://monitoring.us-east-2.amazonaws.com"` |  |
| nextgen-ce.awsServiceEndpointUrls.ec2EndPointUrl | string | `"https://ec2.us-east-2.amazonaws.com"` |  |
| nextgen-ce.awsServiceEndpointUrls.ecsEndPointUrl | string | `"https://ecs.us-east-2.amazonaws.com"` |  |
| nextgen-ce.awsServiceEndpointUrls.enabled | bool | `true` |  |
| nextgen-ce.awsServiceEndpointUrls.endPointRegion | string | `"us-east-2"` |  |
| nextgen-ce.awsServiceEndpointUrls.s3EndPointUrl | string | `"https://s3.us-east-2.amazonaws.com"` |  |
| nextgen-ce.awsServiceEndpointUrls.stsEndPointUrl | string | `"https://sts.us-east-2.amazonaws.com"` |  |
...
| nextgen-ce.image.tag | string | `"80105-000"` |  |
...
| nextgen-ce.imageClickhouseEnabled.tag | string | `"80105-000"` |  |
