...
| batch-processing.cliProxy.enabled | bool | `false` |  |
| batch-processing.cliProxy.host | string | `"localhost"` |  |
| batch-processing.cliProxy.password | string | `""` |  |
| batch-processing.cliProxy.port | int | `80` |  |
| batch-processing.cliProxy.protocol | string | `"http"` |  |
| batch-processing.cliProxy.username | string | `""` |  |
...
| nextgen-ce.image.tag | string | `"80107-000"` |  |
...
| nextgen-ce.imageClickhouseEnabled.tag | string | `"80107-000"` |  |
