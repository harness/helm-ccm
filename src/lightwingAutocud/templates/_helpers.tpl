...
{{- define "lwd-autocud.generateMountSecrets" }}
    ce-batch-gcp-credentials: {{ include "harnesscommon.secrets.passwords.manage" (dict "secret" "lwd-autocud-secret-mount" "key" "ce-batch-gcp-credentials" "providedValues" (list "ce-batch-gcp-credentials") "length" 10 "context" $) }}
{{- end }}

{{- define "lightwingAutocud.pullSecrets" -}}
